...
export const DEFAULT_LEVEL_PARAMS_INT = [
    // P(add), P(sub), P(mul), min_add, max_add, min_sub, max_sub, min_mul, max_mul, min_div_num, max_div_num, div_factor
    [0.6, 0.8, 0.95, 0, 15, 0, 9, 1, 6, 1, 5, 2],       // Level 1
    [0.4, 0.75, 0.95, 0, 15, 0, 10, 1, 9, 1, 5, 2],      // Level 2
    [0.4, 0.7, 0.9, 0, 20, 0, 12, 1, 9, 1, 5, 2],       // Level 3
    [0.35, 0.6, 0.8, 0, 20, 0, 15, 1, 12, 1, 6, 1],      // Level 4
    [0.25, 0.5, 0.75, 0, 25, 0, 15, 1, 12, 1, 6, 1],      // Level 5
    [0.6, 0.8, 0.95, -25, 25, -12, 12, -9, 9, -6, 6, 1], // Level 6
    [0.45, 0.75, 0.95, -25, 25, -12, 12, -9, 9, -7, 7, 1], // Level 7
    [0.4, 0.7, 0.9, -35, 35, -20, 20, -12, 12, -8, 8, 1], // Level 8
